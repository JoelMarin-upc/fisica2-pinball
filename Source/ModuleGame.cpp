...
void ModuleGame::CreateMap()
{
	...
	Chain* flipperWallRight = new Chain(App->physics, screenWidth / 2 + 222, screenHeight - 140, Obstaculo_Derecha, 14, this, obstaculoDerecha_t, EntityType::WALL, 0.f, false, .0f, true);
